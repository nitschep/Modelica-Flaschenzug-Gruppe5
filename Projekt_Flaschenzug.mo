...
//fs_connector1.s = 0;
  ...
  model Gesamtsystem
    ...
    Projekt_Flaschenzug.Motor motor1 annotation(
      Placement(visible = true, transformation(origin = {-85, -77}, extent = {{-31, -31}, {31, 31}}, rotation = 90)));
  ...
  equation
  connect(motor1.fn_connector1, getriebe1.fn_connector1) annotation(
      Line(points = {{-84, -50}, {-84, -39}, {-86, -39}, {-86, -28}}));
...
//U_a = R_a*I_a+L_a*der(I_a)+K_f*omega;
  ...
  equation
    i = fn_connector1.omega / fn_connector2.omega;
    i = fn_connector2.M_l / fn_connector1.M_l;
    annotation(
      Icon(graphics = {Rectangle(origin = {10, -11}, fillColor = {0, 255, 0}, fillPattern = FillPattern.Solid, extent = {{-48, 39}, {48, -39}}), Text(origin = {9, -10}, extent = {{-25, 14}, {25, -14}}, textString = "DSG")}));
  end Getriebe;
  ...
  equation
    ...
    fn_connector1.omega = 0;
    fn_connector1.M_l = 0;
    else
    fn_connector1.omega = fn_connector2.omega;
    fn_connector1.M_l = fn_connector2.M_l;
    end if;
    u_connector1.U_a = 0;
  annotation(
